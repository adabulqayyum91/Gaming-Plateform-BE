...
exports.updateUser = async (data) => {
	...
	(user.userDetail.fullName = data.fullName || user.userDetail.fullName),
		(user.userDetail.about = data.about || user.userDetail.about),
...
exports.updateUserFullName = async (data, userId) => {
	...
	user.userDetail.fullName =
		data.fullName.toLowerCase().trim() || user.userDetail.fullName;
	let userModel = new User(user);
...
exports.setUserOnlineStatus = async (senderId, onlineStatus) => {
	return await User.updateOne(
