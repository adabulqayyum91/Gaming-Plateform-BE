...
exports.createMatchInvitation = async (
	request,
	userId,
	imagePath,
	startDateAndTime
) => {
	console.log({ rules: request.matchRules });
...
exports.createPublicMatchInvitation = async (
	request,
	userId,
	imagePath,
	startDateAndTime
...
exports.findMatchInvitationByIdWithPopulate = async (matchId) => {
	return await Match.findOne({
		...
		"gameToPlay challengeBy challengeTo",
...
exports.findWithDeletedMatchInvitationByIdWithPopulate = async (matchId) => {
	return await Match.findOne({ _id: matchId }).populate(
		"gameToPlay challengeBy challengeTo",
...
exports.findMatchByIdPopulatedWithoutDel = async (matchId) => {
	return await Match.findOne({
		...
		"gameToPlay challengeBy challengeTo",
		"gameName userDetail.userName userDetail.fullName profileImage"
	);
};
...
exports.findMatchByIdPopulatedWithDel = async (matchId) => {
	return await Match.findOne({
		...
		"gameToPlay challengeBy challengeTo",
		"gameName userDetail.userName userDetail.fullName"
	);
};
...
exports.findMyMatches = async (userId) => {
	return await Match.find({
		...
		"gameToPlay challengeBy challengeTo winningUser",
		"gameName userDetail.userName userDetail.fullName"
	);
};
exports.findPublicMatches = async () => {
	return await Match.find({
		...
		"gameToPlay challengeBy  winningUser",
		"gameName userDetail.userName userDetail.fullName"
	);
};
...
exports.getAllMatchesForGame = async () => {
	return await Match.find({ isDeleted: false }, { _id: 0, gameToPlay: 1 });
};
