...
exports.createFranchiseTeam = async (
	teamViewName,
	teamNickName,
	imagePath,
	franchiseId
...
exports.findFranchiseTeamViewNameWithoutDeleted = async (
	teamViewName,
	franchiseId
) => {
...
exports.findInvite = async (teamId, userId, friendId) => {
	return TeamInvite.findOne({
		...
		"teamId from to",
		"teamViewName userDetail.fullName userDetail.userName"
	);
};
...
exports.showAllInvitations = async (pageNo, userId, searchValue = null) => {
	...
	let invitationCondition = [
		{ isDeleted: false, status: "Pending", to: userId },
	];
...
exports.isTeamLeader = async (data, userId) => {
	return await Team.findOne({
		_id: data.teamId,
		teamLeader: mongoose.Types.ObjectId(userId),
	});
};
exports.updateTournamentDetail = async (teamId, tournamentId) => {
	return await Team.updateOne(
		{ _id: teamId },
		{ $push: { participatingInTournaments: tournamentId } }
	);
};
exports.updateTournamentGameDetail = async (teamId, gameToPlay) => {
	return await Team.updateOne(
		{ _id: teamId },
		{ $push: { participatingInGames: gameToPlay } }
	);
};
exports.findTeamDeatilByTeamId = async (teamId) => {
	return await Team.findOne({
		...
		"teamLeader",
		"profileImage userDetail.fullName userDetail.wins userDetail.losses"
	);
};
...
exports.findParticipateInTeam = async (teamId, teamMemberId) => {
	return await Team.findOne({
		_id: teamId,
		"teamMembers.userId": { $in: [mongoose.Types.ObjectId(teamMemberId)] },
	});
};
exports.leaveTeamMember = async (teamId, teamMemberId) => {
	await Team.updateOne(
		{ _id: teamId },
		{
			$pull: {
				teamMembers: {
					userId: { $in: [mongoose.Types.ObjectId(teamMemberId)] },
				},
			},
		}
	);
	await TeamInvite.updateOne(
		{ teamId: teamId, to: mongoose.Types.ObjectId(teamMemberId) },
		{
			$set: {
				isDeleted: true,
				deletedAt: moment(),
...
exports.updateLeagueDetail = async (teamId, leagueId) => {
	return await Team.updateOne(
		{ _id: teamId },
		{ $push: { participatingInLeagues: leagueId } }
	);
};
...
exports.findUserTeam = async (userId) => {
	return await Team.findOne({
		"teamMembers.userId": { $in: [mongoose.Types.ObjectId(userId)] },
		teamType: null,
		isDeleted: false,
...
exports.findUserTeamForTournament = async (userId) => {
	return await Team.find(
		{
			"teamMembers.userId": { $in: [mongoose.Types.ObjectId(userId)] },
			isDeleted: false,
...
exports.updateTeamLeader = async (teamId, leaderId) => {
	return await Team.updateOne(
		{ _id: mongoose.Types.ObjectId(teamId) },
		{ $set: { teamLeader: mongoose.Types.ObjectId(leaderId) } }
	);
};
exports.addUserToTeam = async (teamId, userObj) => {
	return await Team.updateOne(
		{ _id: mongoose.Types.ObjectId(teamId) },
		{ $push: { teamMembers: userObj } }
	);
};
	...
	return await Team.updateOne(
		{
			_id: mongoose.Types.ObjectId(teamId),
			teamMembers: {
				$elemMatch: { userId: mongoose.Types.ObjectId(memberId) },
			},
		},
