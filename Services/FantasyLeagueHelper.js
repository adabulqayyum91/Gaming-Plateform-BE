...
exports.findFantasyLeagueByIdWithoutDelete = async (fantasyLeagueId) => {
	return await FantasyLeague.findOne({
		_id: mongoose.Types.ObjectId(fantasyLeagueId),
		isDeleted: false,
	});
};
...
exports.creatFantasyLeague = async (
	flName,
	totalTeams,
	teamSize,
	draftDateAndTime,
...
exports.addFantasyTeam = async (fantasyLeagueId, userFantasyTeamId) => {
	return await FantasyLeague.updateOne(
		{ _id: mongoose.Types.ObjectId(fantasyLeagueId) },
...
exports.findFantasyLeagueByFlTeam = async (flTeamId) => {
	return await FantasyLeague.findOne({
		flTeams: { $in: [mongoose.Types.ObjectId(flTeamId)] },
		isDeleted: false,
	});
};
...
exports.searchFantasyLeagueByNameWithPagination = async (searchStr, pageNo) => {
	...
	let result = await FantasyLeague.find({
		...
		isDeleted: false,
		$or: [
			{ flName: { $regex: searchStr } },
			{ leagueName: { $regex: searchStr } },
		],
	})
		.skip(pg.skip)
		.limit(pg.pageSize)
...
exports.updateFantasyLeagueDetail = async (data) => {
	let flDetail = await FantasyLeague.findOne({
...
exports.deleteFantasyLeague = async (flId) => {
	return await FantasyLeague.updateOne(
		{ _id: mongoose.Types.ObjectId(flId) },
		{
			$set: {
				isDeleted: true,
				deletedAt: moment(),
...
exports.findAllReceivedFlRequest = async (userId) => {
	return await FantasyTeamInvite.find({
...
exports.findRequestedInvite = async (fantasyLeagueId, userId, fromId) => {
	return await FantasyTeamInvite.findOne({
		...
		"fantasyLeagueId from to",
		"flName userDetail.fullName userDetail.userName"
	);
};
exports.updateInvitationStatus = async (
	fantasyLeagueId,
	userId,
	fromId,
	status
...
exports.saveFantasyLeagueSchedule = async (
	roundNumber,
	srNo,
	id,
	randomNumber,
...
exports.checkPendingFantasyLeagueScheduleWinner = async (
	fantasyLeagueId,
	roundNumber
) => {
	return await FantasyLeagueSchedule.find({
...
exports.getPlayerLeaguePointByRoundNumber = async (
	leaguePlayerId,
	leagueId,
	maxRoundNumber
) => {
...
exports.updateFantasyLeagueScheduleResult = async (
	roundNumber,
	fantasyLeagueId,
	teamOneId
) => {
	return await FantasyLeagueSchedule.updateOne(
		{
			...
			fantasyLeagueId: mongoose.Types.ObjectId(fantasyLeagueId),
			$or: [
				{ teamOne: mongoose.Types.ObjectId(teamOneId) },
				{ teamTwo: mongoose.Types.ObjectId(teamOneId) },
			],
		},
		{ $set: { winner: teamOneId } }
	);
};
exports.addFantasyTeamPoint = async (
	maxRoundNumber,
	teamFinalPoints,
	flTeamId,
	leagueId,
...
exports.getPreviousRoundFourTeamList = async (
	fantasyLeagueId,
	leagueId,
	maxRoundNumber
) => {
	return await FantasyLeagueTeamPoints.find(
		...
		{ flTeamId: 1, points: 1, _id: 0 }
	).sort({ points: -1 });
};
exports.getPreviousRoundWinnerList = async (
	fantasyLeagueId,
	leagueId,
	maxRoundNumber
) => {
...
exports.findAlreadyTeamPointsExistForScheduleRound = async (
	leagueId,
	fantasyLeagueId,
...
exports.updateTeamPointWinner = async (
	fantasyLeagueId,
	maxRoundNumber,
	teamId
) => {
...
exports.updateTeamPointLooser = async (
	fantasyLeagueId,
	maxRoundNumber,
	teamId
) => {
...
exports.getPlayerPointsByLeagueIdAndMaxRoundNumber = async (
	playerId,
	leagueId,
	fantasyLeagueId,
	roundNumber
...
exports.findMaxPlayOffRoundNumber = async (leagueId, fantasyLeagueId) => {
	return await FantasyLeagueSchedule.find({
		leagueId: mongoose.Types.ObjectId(leagueId),
		fantasyLeagueId: mongoose.Types.ObjectId(fantasyLeagueId),
	})
...
exports.updateNextMatchId = async (
	...
	await FantasyLeagueSchedule.updateOne(
		{
			leagueId: mongoose.Types.ObjectId(leagueId),
			fantasyLeagueId: mongoose.Types.ObjectId(fantasyLeagueId),
...
exports.findFantasyLeagueByIdWithDeleteWithPopulate = async (
	fantasyLeagueId
) => {
	return await FantasyLeague.findOne({
		_id: mongoose.Types.ObjectId(fantasyLeagueId),
	}).populate("gameToPlay createdBy", "gameName userDetail.userName");
};
exports.updateWinner = async (leagueId, fantasyLeagueId, winnerTeam) => {
	return await FantasyLeagueSchedule.updateOne(
		{
			leagueId: mongoose.Types.ObjectId(leagueId),
			fantasyLeagueId: mongoose.Types.ObjectId(fantasyLeagueId),
...
exports.deleteFlTeamFromFl = async (flid, flTeamId) => {
	return await FantasyLeague.updateOne(
		{ _id: mongoose.Types.ObjectId(flid) },
		{ $pull: { flTeams: { $in: [mongoose.Types.ObjectId(flTeamId)] } } }
	);
};
