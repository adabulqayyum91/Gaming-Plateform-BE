...
exports.userFranchise = async (userId) => {
	return Franchise.findOne({createdBy: mongoose.Types.ObjectId(userId), isBlock: false})//, isDeleted: false
}
...
exports.showAllFranchiseWithoutDeleteAndBlock = async () => {
	return await Franchise.find({isDeleted: false, isBlock: false})
}
...
exports.franchiseByStatusWithoutDeleteAndBlock = async (franchiseStatus) => {
	return await Franchise.find({isDeleted: false, isBlock: false, franchiseStatus: franchiseStatus})
}
