...
exports.createUser = async (req, res, next) => {
	...
	///welcome email
	let subject = "Welcome To GamingPlateform (GP)";
	let message = ".";
	const replacements = {
		link: "go.GamingPlateform.com", // hard code because env update issue
...
exports.forgot = async (req, res, next) => {
	...
	const replacements = {
		link: "go.GamingPlateform.com/auth/reset/" + foundUser._id, // hard code because env update issue
		appName: process.env.APP_NAME,
		mailFrom: process.env.MAIL_FROM,
	};
...
exports.contactUsSend = async (req, res) => {
	...
	//send mail
	let subject = emailSubject + " - GamingPlateform (GP)";
	let message = msgBody + " \n\nSent by : " + senderEmail;
