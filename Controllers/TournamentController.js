...
exports.showTournamentsForResult = async (req, res) => {
	...
	if (!req.query.query) {
		tournamentForResult =
			await TournamentResultHelper.findAdminTournamentForResultWithPagination(
				pageNo
			);
	}
	if (req.query.query) {
		...
		tournamentForResult =
			await TournamentResultHelper.findAdminTournamentResultByTournamentNameWithPagination(
